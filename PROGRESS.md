...
- [x] Finalisasi keputusan arsitektur & stack (Laravel 13 + Vue 3 + PostgreSQL, modular monolith, tanpa Filament)
...
- Keputusan arsitektur: EIP = Enterprise Integration Platform, modular monolith,
  Laravel 13 + PostgreSQL, frontend Vue 3 + Element Plus, tanpa Filament
